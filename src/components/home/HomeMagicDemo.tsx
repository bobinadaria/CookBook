...
export default function HomeMagicDemo() {
  ...
  const demoSteps = t.raw("demoSteps") as string[];
  ...
  return (
    <section className="border-b border-rule bg-paper">
      <div className="mx-auto max-w-[1320px] px-6 py-12 md:px-10 md:py-16 lg:px-14 lg:py-20">
        {/* Заголовок */}
          ...
          <ol className="mt-4 flex flex-wrap items-center gap-x-2.5 gap-y-1.5 font-body text-[11px] font-semibold uppercase tracking-[0.14em] text-soft sm:hidden">
            {demoSteps.map((s, i) => (
              <li key={s} className="flex items-center gap-2.5">
                ...
                <span><b className="not-italic text-ochre-dk">{i + 1}</b>&nbsp;{s}</span>
              </li>
            ))}
          </ol>
        </div>
        ...
        <div className="overflow-hidden border border-rule bg-crust">
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="border-b border-rule p-5 md:border-b-0 md:border-r md:p-7">
              ...
              <div
                className={cn(
                  "mt-4 transition-opacity duration-500 sm:mt-5",
            ...
            {/* Обложка */}
            <div className="relative aspect-[16/10] overflow-hidden bg-crust sm:aspect-square md:aspect-auto md:min-h-[300px]">
              <Image
                src="/demo-cover.jpg"
          ...
          <div
            className={cn(
              "bg-section px-5 py-5 text-section-fg transition-opacity duration-500 md:px-7 md:py-6",
        ...
        {/* Повтор — сразу под «окном» демо, к которому относится */}
        {!reduced && (
